 ...
 */
export type HttpGatewayTimeoutAction = (injector: Injector, observer: Observer<unknown>) => void;
...
export class HttpGatewayTimeoutInterceptorOptions
{
     ...
     * Text displayed
     */
    public text: string = 'Server did not respond in defined time.';

    /**
     * Action called when 504 status code received
     */
    public action: HttpGatewayTimeoutAction = (injector: Injector, observer: Observer<unknown>) =>
    {
