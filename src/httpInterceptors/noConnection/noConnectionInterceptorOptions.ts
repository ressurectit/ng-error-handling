 ...
 */
export type NoConnectionAction = (injector: Injector, observer: Observer<unknown>) => void;
...
export class NoConnectionInterceptorOptions
{
     ...
     * Text displayed
     */
    public text: string = 'Server is offline. Try again later.';

    /**
     * Action called when 0 status code received
     */
    public action: NoConnectionAction = (injector: Injector, observer: Observer<unknown>) =>
    {
